...
Откройте Postman
Создайте новую коллекцию: Django Blog API
В настройках коллекции добавьте переменные:
...
Перейдите в настройки коллекции → Authorization
Выберите Type: Bearer Token
В поле Token введите: {{access_token}}
...
Симуляция успешного платежа (изменение статуса вручную в БД)
Создание поста
Закрепление поста
Проверка что пост отображается в закрепленных
...
Создание тестовых данных (категория, пост)
Тестирование платежной системы
Тестирование подписок
Тестирование закрепления постов
Тестирование комментариев
Специальные эндпоинты (популярные, закрепленные, рекомендуемые посты)
Фильтрация и поиск с учетом закрепленных постов
Тестирование ошибок и edge cases
Интеграционные тесты
Админские функции (аналитика, управление)
Очистка тестовых данных
Выход из системы
...
Выберите коллекцию → Run collection
Установите задержку: 1000ms между запросами
Выберите окружение с переменными
Запустите в правильном порядке
Сохраните результаты тестирования
